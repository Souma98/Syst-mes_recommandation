...
import Textes from "./textes_rec" ;

class  page_textes_recommandes extends React.Component {
    constructor(props){  
		super(props);  
  ...
  <div >
      ...
      <div class=" div_principal" >
          ...
          <div class="div-textes  text-gray-500">
            <span>
              ...
              <h1 class="titre-principal  ml-4">Textes recommandés</h1>
            </span>
          </div>
          {this.state.showButton  ?       
                 
        <Textes closeLire={this.LireButton.bind(this)} /> : null } 
        <Textes/>
        <Textes/>   
      ...
      <div class="pagination">
          <ul class="flex">
                     <li class="mx-1 px-3 py-2 bg-gray-200 text-gray-700 button:hover hover:text-gray-200 rounded-lg">
                    ...
                    <li class="mx-1 px-3 py-2 bg-gray-200 text-gray-700 hover:bg-gray-700 hover:text-gray-200 rounded-lg">
                        <a class="font-bold" href="">4</a>
                    </li>
                    <li class="mx-1 px-3 py-2 bg-gray-200 text-gray-700 hover:bg-gray-700 hover:text-gray-200 rounded-lg">
                        <a class="font-bold" href="">5</a>
                    </li>
                    <li class="mx-1 px-3 py-2 bg-gray-200 text-gray-700 hover:bg-gray-700 hover:text-gray-200 rounded-lg">
                        <a class="flex items-center font-bold" href="">
                            <span class="mx-1">
...
export default  page_textes_recommandes;